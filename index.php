...
<head>
    ...
    <style>
        body {
            ...
            background-color: #F8F3D9; /* Warna latar belakang */
        ...
        .nav-link:hover {
            color: #B9B28A; /* Mengubah warna saat hover */
            transform: scale(1.1); /* Membesarkan tautan saat hover */
        }

        .container {
            background-color: #EBE5C2; /* Latar belakang kontainer */
        ...
        .welcome-image img {
            max-width: 80%;
            height: auto;
            margin-left: auto; /* Menambahkan margin kiri otomatis untuk mendorong gambar ke kanan */
            display: block; /* Memastikan margin bekerja dengan benar */
        }
    </style>
</head>
<body>
    ...
    <main class="container my-5">
        <div class="row welcome-row">
            ...
            <div class="col-lg-6 welcome-image">
                <img src="tulisanku.jpeg" alt="" class="img-fluid">
            </div>
        </div>
    </main>
