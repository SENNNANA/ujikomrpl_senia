...
<head>
    ...
    <style>
        ...
        .header {
            background-color: #B9B28A; /* Warna navbar */
        ...
        .data-container {
            ...
            background-color: #EBE5C2; /* Latar belakang kontainer data */
            padding: 30px;
        ...
        th {
            background-color: #B9B28A; /* Warna header tabel */
            color: #504B38; /* Warna teks header tabel */
            padding: 15px;
            text-align: left;
...
<header class="header p-4">
    <div class="container d-flex justify-content-between align-items-center">
        <div class="text-lg font-weight-bold" style="color: #F3F7EC;">GUDANG ALAT TULIS KANTOR</div>
        <nav class="nav">
